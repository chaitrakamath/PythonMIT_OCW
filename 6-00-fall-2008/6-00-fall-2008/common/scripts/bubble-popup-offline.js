...
'a_logo_17.gif': 'When you purchase this book (or other media) from Amazon.com,<b> MIT OpenCourseWare will receive up to 10% of this purchase</b> and any other purchases you make during that visit. <a href="http://ocw.mit.edu/donate/support-ocw-by-shopping-at-amazon/">Learn more</a>.',
...
'icon-question-cim.png':'<strong>CI-M</strong> (Communication Intensive in the Major): MIT undergraduates must take two such courses, which focus on forms of communication relevant to a given field. <a href="http://web.mit.edu/commreq/cim.html">Learn more</a>.',
...
'icon-question-gir.png':'<strong>GIR</strong> (General Institute Requirements): MIT undergraduates must take certain courses in science and technology; communication; humanities, arts, and social sciences; laboratory; and physical education. <a href="http://web.mit.edu/catalog/overv.chap3-gir.html">Learn more</a>.',
// Match for educator H-Level Graduate Credit mouseover						  
'icon-question-hlevel.png':'<strong>H-Level Graduate Credit</strong>: Courses with this designation are approved higher-level graduate subjects required for MIT graduate programs. <a href="http://web.mit.edu/catalog/overv.chap4-gdr.html">Learn more</a>.',
...
'icon-question-hass-h.png':'<strong>HASS-H</strong>: MIT undergraduates must take one course designated as Humanities in fulfilling the eight-course requirement in Humanities, Arts, and Social Sciences. <a href="http://web.mit.edu/hassreq/index.html#hasscatdef">Learn more</a>.',
...
'icon-question-lab.png':'<strong>Lab</strong>: MIT undergraduates must take one such course, which emphasizes experimental problems and introduces students to how research in the discipline is conducted. <a href="http://web.mit.edu/catalog/overv.chap3-gir.html#lr">Learn more</a>.',
// Match for educator REST mouseover
'icon-question-rest.png':'<strong>REST</strong> (Restricted Electives in Science and Technology): MIT undergraduates must take two such courses, which broaden and deepen students\' understanding of basic science and scientific inquiry. <a href="http://web.mit.edu/catalog/overv.chap3-gir.html#restr">Learn more</a>.',
...
'icon-question-svt.png':'OCW Scholar courses are among OCW\'s most complete courses, blending content created expressly for OCW with material from on-campus MIT classes. <a href="http://ocw.mit.edu/courses/ocw-scholar/">Learn more about OCW Scholar</a>. ',
// Match for Archived Version tool tip mouseover
'icon-question-avt.png':'These older versions have been replaced by more recent versions, and are archived in the <a href="http://dspace.mit.edu/">DSpace@MIT Repository</a>. ',
